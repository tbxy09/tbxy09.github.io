...
app.mount("/c", StaticFiles(directory="project"), name="project")
# @app.mount("/c/{project_id}/static", StaticFiles(directory=Path(projects_dir) / project_id / "static"), name="static")
